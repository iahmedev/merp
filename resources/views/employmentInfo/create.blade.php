<x-app-layout>
    ...
    <div class="grid place-items-center">
        <ul class="menu mt-8 bg-white md:menu-horizontal rounded-box">
            ...
            <li>
                <a href="{{ $user->nextOfKin ? route('nextOfKin.edit', $user->nextOfKin) : route('nextOfKin.create', $user) }}"
                    class="font-medium text-base">
                    Next of Kin
                </a>
            </li>
                ...
                <section>
                    <header>
                        ...
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                            {{ __('Update employment information.') }}
                        </p>
                    </header>

                    <form action="{{ route('employmentInfo.store') }}" method="post" class="">
                        @csrf
                            ...
                            <div class="w-full md:w-1/2 space-y-4">
                                <div>
                                    ...
                                    <x-text-input id="employee_id" name="employee_id" type="text"
                                        class="input-md mt-1 block w-full" :value="old('employee_id')" required autofocus
                                ...
                                <div>
                                    ...
                                    <select class="select select-bordered mt-1 block w-full" name="employment_type_id"
                                        ...
                                        <option disabled {{ old('employment_type_id') ? '' : 'selected' }}>
                                            Select Employment Type
                                        </option>
                                        @foreach ($emp_types as $emp_type)
                                            <option value="{{ $emp_type->id }}"
                                                {{ old('employment_type_id') == $emp_type->id ? 'selected' : '' }}>
                                                {{ $emp_type->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select class="select select-bordered mt-1 block w-full" name="employment_status_id"
                                        ...
                                        <option disabled {{ old('employment_status_id') ? '' : 'selected' }}>
                                            Select Employment Status
                                        </option>
                                        @foreach ($emp_status as $emp_status)
                                            <option value="{{ $emp_status->id }}"
                                                {{ old('employment_status_id') == $emp_status->id ? 'selected' : '' }}>
                                                {{ $emp_status->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <x-text-input id="date_of_employment" name="date_of_employment" type="date"
                                        class="input-md mt-1 block w-full" :value="old('date_of_employment')" required autofocus
                            ...
                            <div class="w-full md:w-1/2 space-y-4">
                                <div>
                                    ...
                                    <select class="select select-bordered mt-1 block w-full" name="department_id"
                                        ...
                                        <option disabled {{ old('department_id') ? '' : 'selected' }}>
                                            Select Department
                                        </option>
                                ...
                                <div>
                                    ...
                                    <select class="select select-bordered mt-1 block w-full" name="designation_id"
                                        ...
                                        <option disabled {{ old('designation_id') ? '' : 'selected' }}>
                                            Select Designation
                                        </option>
                                ...
                                <div>
                                    ...
                                    <x-text-input id="date_of_last_promotion" name="date_of_last_promotion"
                                        type="date" class="mt-1 block w-full" :value="old('date_of_last_promotion')" autofocus
