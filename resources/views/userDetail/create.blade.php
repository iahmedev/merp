        ...
        <div class="flex justify-center">
            <div class="w-1/2 p-8 m-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <section>
                    ...
                    <form action="{{ route('userDetail.store') }}" method="post" class="">
                        @csrf
                            ...
                            <div class="w-full md:w-1/2 space-y-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="lga" name="lga" type="text" class="mt-1 block w-full"
                                        :value="old('lga')" required autofocus autocomplete="lga" />
                            ...
                            <div class="w-full md:w-1/2 space-y-4">
                                <div>
                                    ...
                                    <select class="select select-bordered mt-1 block w-full" name="gender" required
                                        ...
                                        <option disabled {{ old('gender') ? '' : 'selected' }}>
                                ...
                                <div>
                                    ...
                                    <select class="select select-bordered mt-1 block w-full" name="marital_status"
                                        required autofocus autocomplete="marital_status">
                                        <option disabled
                                ...
                                <div>
                                    ...
                                    <x-text-input id="date_of_birth" name="date_of_birth" type="date"
                                        class="mt-1 block w-full" :value="old('date_of_birth')" required autofocus
                                ...
                                <div>
                                    ...
                                    <x-text-input id="nin" name="nin" type="text" class="mt-1 block w-full"
                                        :value="old('nin')" required autofocus autocomplete="nin" />
